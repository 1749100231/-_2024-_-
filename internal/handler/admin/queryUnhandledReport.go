...
type queryUnhandledReport struct {
	UserID int64 `form:"user_id" binding:"required"`
}

func QueryUnhandledReport(c *gin.Context) {
	var data queryUnhandledReport
	...
	err, queryData := service.QueryUnhandledReport(data.UserID)
	if err != nil {
